class ServiceBlueprintConfigurator {
  ...
  get formObject() {
    ...
    return {
      ...
      set_script: {
        content_mode: this.object.set_script.language,
        content: this.object.set_script.content,
      },
      set_script_sudo: {
        content_mode: this.object.set_script_sudo.language,
        content: this.object.set_script_sudo.content,
      },
      read_script: {
        content_mode: this.object.read_script.language,
        content: this.object.read_script.content,
      },
      read_script_sudo: {
        content_mode: this.object.read_script_sudo.language,
  ...
  formSubmit( formObject ) {
    ...
    if ( formObject.set_script.content ) {
      formObject.set_script.language = formObject.set_script.content_mode
    }
    formObject.set_script_sudo = formObject.set_script_sudo || {}
    if ( formObject.set_script_sudo.content ) {
      formObject.set_script_sudo.language = formObject.set_script_sudo.content_mode
    }
    formObject.read_script = formObject.read_script || {}
    if ( formObject.read_script.content ) {
      formObject.read_script.language = formObject.read_script.content_mode
    }
    formObject.read_script_sudo = formObject.read_script_sudo || {}
    if ( formObject.read_script_sudo.content ) {
      formObject.read_script_sudo.language = formObject.read_script_sudo.content_mode
    }
