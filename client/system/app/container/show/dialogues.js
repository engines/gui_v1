app.container.show.dialogues = ( type, controller, container ) => (a,x) => {
  ...
  if( container.status.state === 'running' ) {
    ...
    return app.http(
      ...
      ( blueprint, el ) => {
        ...
        let dialogues = blueprint.dialogues || ( ( inDevelopment && ( container.name === 'uadmin' ) ) ? uadminBlueprint.software.dialogues : [] ) || []
